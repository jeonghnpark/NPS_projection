...
from visualization import save_results_to_csv, create_financial_plots
...
# plt.grid(True)
# plt.tight_layout()
# plt.savefig(f"images/nps_reserve_fund_{timestamp}.png", dpi=300, bbox_inches="tight")
# plt.close()
